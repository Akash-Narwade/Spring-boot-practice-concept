...
public class CustomerEventService {
	...
	public void invokeCustomerEvent() {
		...
		String eventResponse = webClient.get().uri(REST_URL1).retrieve().bodyToMono(String.class).block();
	...
	public void invokeCustomerEvents() {
	    ...
	    webClient.get().uri(REST_URL2).retrieve().bodyToFlux(String.class).subscribe(System.out::print);
